    ...
    data() {
      return {
        ...
        queryParams: {
          ...
          // params: {
          //   beginStartDate: '1980-01-01',
          //   endStartDate: '1980-01-01',
          //   beginFinalDate: '1980-01-01',
          //   endFinalDate: '1980-01-01',
          //   beginModifyDate: '1980-01-01',
          //   endModifyDate: '1980-01-01'
          // }
        },
        // 表单参数
        form: {},
    ...
    methods: {
      ...
      getList() {
        ...
        if (null != this.startDateRange && '' != this.startDateRange) {
          this.queryParams.params["beginStartDate"] = this.startDateRange[0];
          this.queryParams.params["endStartDate"] = this.startDateRange[1];
        }
        // 失效日期判断
        if (null != this.finalDateRange && '' != this.finalDateRange) {
          this.queryParams.params["beginFinalDate"] = this.finalDateRange[0];
          this.queryParams.params["endFinalDate"] = this.finalDateRange[1];
        }
        // 变动日期判断
        if (null != this.modifyDateRange && '' != this.modifyDateRange) {
          this.queryParams.params["beginModifyDate"] = this.modifyDateRange[0];
          this.queryParams.params["endModifyDate"] = this.modifyDateRange[1];
        }
